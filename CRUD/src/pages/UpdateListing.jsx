  ...
  const UpdateListing = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
          ...
          if (+formData.regularPrice < +formData.discountPrice) return setError('Discount price must be lower than the regularPrice!')  
        setLoading(true);
        setError(false);
      ...
      <main className="p-3 max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex flex-col flex-1 gap-4">
            ...
            <button
              className="p-3 rounded-lg bg-gray-700 text-white uppercase hover:opacity-95 disabled:opacity-80"
