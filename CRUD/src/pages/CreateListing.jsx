      ...
      <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-6'>
             ...
             <div className='flex flex-col gap-4 flex-1'>
                ...
                className='p-3 border rounded-lg' maxLength='60' minLength='10' required
                />
             ...
             <div className='flex flex-col flex-1 gap-4'>
                ...
                <button className="p-3 rounded-lg bg-gray-700 text-white uppercase hover:opacity-95 disabled:opacity-80">Create Listing</button>
             </div>  
        </form>
      </main>
    );
